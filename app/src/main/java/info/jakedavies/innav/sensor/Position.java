...
public class Position {
    ...
    private ArrayList<info.jakedavies.innav.lib.map.Beacon> beacons;
    ...
    public Position(Context context, PositionChangedListener headingChangedListener, ArrayList<info.jakedavies.innav.lib.map.Beacon> beacons) {
